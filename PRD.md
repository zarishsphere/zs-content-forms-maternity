# PRD — `zs-content-forms-maternity`
...
Maternity forms — ANC contacts (1–8), PNC visits, delivery records, postnatal checks.

---

## 2. Repository Metadata

- **Name:** `zs-content-forms-maternity`
...
- Provide validated JSON Schema clinical forms for maternity workflows
...
```json
{
  ...
  "title": "Maternity Form",
  "version": "1.0.0",
  "fhirResource": "Observation",
  "sections": [{
    "id": "section-1",
    "title": "{{i18n:forms.maternity.section1}}",
    "fields": [{
      "id": "field-1",
      "type": "number",
      "label": "{{i18n:forms.maternity.field1}}",
