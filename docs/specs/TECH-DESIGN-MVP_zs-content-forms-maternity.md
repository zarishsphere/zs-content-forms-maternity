# TECH-DESIGN-MVP — `zs-content-forms-maternity`

> **Document:** Technical Design (MVP) | **Version:** 1.0.0-mvp
> **Repository:** [https://github.com/zarishsphere/zs-content-forms-maternity](https://github.com/zarishsphere/zs-content-forms-maternity)
> **Layer:** Layer 6A | **Catalog #:** 141
...
**ANC contacts 1–8, PNC visits, delivery record, partograph.**

This document defines the **technical architecture, implementation design, complete repository tree, and acceptance criteria** for the MVP of `zs-content-forms-maternity`.
...
```json
{
  ...
  "id": "zs-form-maternity-01",
  "title": "{{i18n:forms.maternity.title}}",
  "version": "1.0.0",
  "fhirResource": "Observation",
  "sections": [
    {
      "id": "section-main",
      "title": "{{i18n:forms.maternity.section_main}}",
      "fields": [
        {
          "id": "field-001",
          "type": "number",
          "label": "{{i18n:forms.maternity.field_001}}",
...
*This document is the authoritative MVP specification for `zs-content-forms-maternity`.*
