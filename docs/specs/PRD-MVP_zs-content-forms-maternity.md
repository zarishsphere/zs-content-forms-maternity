# PRD-MVP — `zs-content-forms-maternity`
...
> **Layer:** Layer 6A — Clinical Content | **Catalog #:** 141
...
This document defines the **Minimum Viable Product (MVP)** scope for `zs-content-forms-maternity` within the ZarishSphere sovereign digital health platform. It covers what must be built first, acceptance criteria, user stories, and the complete repository file structure.
